...
def Stimulated_Annealing(max_or_min ,x_limit, y_limit):
    ...
    # the second funtion given
    func = ((100 * (((x**2) - y)**2)) + (1-x)**2)
    ...
    for i in range(1, temp):
        ...
        for j in range(1, iter):
            ...
            trial = ((100 * (((updated_x**2) - updated_y)**2)) + (1-updated_x)**2)
...
# results =  Stimulated_Annealing('max',[-2, 2], [-1, 3])
results =  Stimulated_Annealing('min',[-2, 2], [-1, 3])
